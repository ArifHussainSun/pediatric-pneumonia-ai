...
The MobileNet V1 model shows excellent performance on real-world chest X-ray data with 98.5% accuracy. Preprocessing provides modest benefits and may need optimization.